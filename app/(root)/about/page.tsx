...
const About = () => {
    return (
        <>
            ...
            <div className="wrapper mx-3 py-3 my-4 group relative flex min-h-[480px] max-w-[400px] flex-col overflow-hidden rounded-xl bg-white shadow-md transition-all hover:shadow-lg bg-gray-800">
                <p className="p-medium-16 md:p-medium-20 line-clamp-2 mx-3 py-1 flex-1 text-white">eVenTO:</p>
                <p className="text-black p-2  text-white">
